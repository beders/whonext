...
A silly little app to show some of re-frame's basic features and to help us run stand-up.
It shuffles a list of names and shows who goes next.
...
* [`src/cljs/whonext/`](src/cljs/whonext/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/whonext/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `whonext` project root directory
